...
//        Optional<UserOld> maybeUser = userService.requestPasswordReset("invalid.login@localhost");
...
//        userRepository.saveAndFlush(user);
//
//        Optional<UserOld> maybeUser = userService.requestPasswordReset(user.getLogin());
//        assertThat(maybeUser).isNotPresent();
...
//        userRepository.saveAndFlush(user);
//
//        Optional<UserOld> maybeUser = userService.completePasswordReset("johndoe2", user.getResetKey());
//        assertThat(maybeUser).isNotPresent();
//        userRepository.delete(user);
//    }
//
...
//        UserOld dbUser = userRepository.saveAndFlush(user);
//        dbUser.setCreatedDate(now.minus(4, ChronoUnit.DAYS));
//        userRepository.saveAndFlush(user);
//        Instant threeDaysAgo = now.minus(3, ChronoUnit.DAYS);
//        List<UserOld> users = userRepository.findAllByActivatedIsFalseAndActivationKeyIsNotNullAndCreatedDateBefore(threeDaysAgo);
...
//        assertThat(users).isEmpty();
//        userService.removeNotActivatedUsers();
//        Optional<UserOld> maybeDbUser = userRepository.findById(dbUser.getId());
